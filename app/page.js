...
className="relative min-h-[100dvh] w-full flex flex-col items-center justify-end p-4 pb-1 md:justify-center bg-cover bg-[center_top_20%] md:bg-center bg-no-repeat bg-[url('/fondocatamobile2.png')] md:bg-[url('/fondocata4.jpg')]"    
>
